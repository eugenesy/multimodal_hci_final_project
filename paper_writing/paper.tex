...
\begin{teaserfigure}
  \centering
  \fbox{%
    \parbox[c][7cm][c]{0.96\textwidth}{%
      \centering
      \large\textit{[Figure 1 placeholder --- game screenshot / system diagram]}}}
  \caption{The \emph{PathSense} interface. Left: the tightrope balance
    game displayed on the external monitor. Right: the participant's phone
    showing proximity feedback and tilt controls. Proximity warning levels
    (SAFE / NEAR / WARN / DANGER) escalate as the ball approaches the path
    edge.}
  \Description{Placeholder for a two-panel figure showing the game display
    and the phone controller interface.}
  \label{fig:teaser}
\end{teaserfigure}
...
%   Figure 1 (system diagram / game screenshot)
% =========================================================================
